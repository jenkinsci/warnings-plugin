...
/**
     ...
     * */
    private static final String DOXYGEN_WARNING_PATTERN = ANT_TASK
     ...
     *            a string containing the warning type returned by a regular expression group matching it in the
     *            warnings output.
     * @return the priority
     */
