 ...
 */
public abstract class SonarQubeParser extends AbstractWarningsParser {
    ...
    /**
     * Creates a new instance of {@link SonarQubeParser}.
     * @param parserName
     * @param linkName
     * @param trendName
     */
    protected SonarQubeParser(final Localizable parserName, final Localizable linkName, final Localizable trendName) {
        super(parserName, linkName, trendName);
    }

    @Override
    public final Collection<FileAnnotation> parse(final Reader reader) throws IOException {
     ...
     */
    public FileAnnotation parseIssue(final JSONObject issue) {
        //file
        ...
        return createWarning(filename, start, type, category, message, priority);
    }
