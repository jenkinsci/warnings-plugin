...
public class SdccParserTest extends ParserTester {
    ...
    public void Sdcc_warning1() throws IOException {
        ...
        checkWarning(annotation, 806, "left shifting more than size of object changed to zero", "../../../Lib/Src/AlBus/AlBus.c", "warning", Priority.NORMAL);
    }
   ...
   @Test
    public void Sdcc_warning2() throws IOException {
        ...
        checkWarning(annotation, 125, "backslash-newline at end of file", "../../Src/HrCommunication/HrAlTagList.c", "warning", Priority.NORMAL);
    }
   ...
   @Test
    public void Sdcc_warning3() throws IOException {
        ...
        checkWarning(annotation, 144, "#warning \"There is a rounding error in the denominator for ST_Cycles_T to SystemTimer period conversion!\"", "../../Src/TriacModulation/TriacModulation.c", "warning", Priority.NORMAL);
    }
   ...
   @Test
    public void Sdcc_warning4() throws IOException {
        ...
        checkWarning(annotation, 150, "#warning \"There is a rounding error in the denominator for AcPeriod_T to SystemTimer period conversion!\"", "../../Src/TriacModulation/TriacModulation.c", "warning", Priority.NORMAL);
    }
   ...
   @Test
    public void Sdcc_error1() throws IOException {
        ...
        checkWarning(annotation, 27, "token -> 'Modbus_UpdateTimers' ; column 21", "../../Src/main.c", "syntax error", Priority.HIGH);
    }
    ...
    protected FileAnnotation getErrorNumber( final int number) throws IOException {
        List<FileAnnotation> warnings = new SdccParser().parse(openFile("sdcc_Output.txt"));
